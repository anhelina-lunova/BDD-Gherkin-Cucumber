...
Given(
  "the customer is on the homepage of the Rozetka online marketplace",
  function () {
    console.log("\nYou are on the homepage of the Rozetka online marketplace");
  }
);
...
Given(
  "the customer is on the page of the online marketplace Rozetka where cards with a preview of products are displayed, grouped by a certain characteristic",
  function () {
    console.log("\nYou see an item list of previously chosen product");
  }
);
...
Given("the minimum of one product has been added to the cart", function () {
  console.log("\nYou have one or more items in your cart");
});
...
When(
  ...
  function (cartReceiptSubmitOrder) {
    assert.strictEqual("Оформити замовлення", cartReceiptSubmitOrder);
  }
);
...
Given(
  "the customer is on the checkout page of the Rozetka online marketplace",
  function () {
    console.log(
      "\nYou are on the checkout page of the Rozetka online marketplace"
    );
  }
);
...
When("the customer clicks the button {string}", function (button) {
  assert.strictEqual("Замовлення підтверджую", button);
});
